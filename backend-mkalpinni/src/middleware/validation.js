...
// Validaciones para usuario/auth
const validateRegister = [
  ...
  body('idrol')
    .isInt({ min: 1, max: 3 })
    .withMessage('El rol debe ser 1 (Propietario), 2 (Inquilino) o 3 (Administrador)'),
  body('telefono')
    .optional()
    .isMobilePhone('es-AR')
...
const validateProperty = [
  ...
  body('transaccionTipo')
    .isIn(['Venta', 'Alquiler'])
    .withMessage('Tipo de transacción debe ser Venta o Alquiler'),
  body('habitaciones')
    .optional()
    .isInt({ min: 0 })
    .withMessage('Las habitaciones deben ser un número entero mayor o igual a 0'),
  body('banos')
    .optional()
    .isInt({ min: 0 })
    .withMessage('Los baños deben ser un número entero mayor o igual a 0'),
  body('superficieM2')
    .optional()
    .isFloat({ min: 0 })
    .withMessage('La superficie debe ser un número mayor o igual a 0'),
  body('latitud')
    .optional()
...
const validateClient = [
  ...
  body('dni')
    ...
    .withMessage('El DNI debe contener solo números y tener entre 7 y 8 dígitos'),
  body('email')
    .isEmail()
    .normalizeEmail()
  ...
  body('domicilio')
    ...
    .withMessage('El domicilio debe tener entre 5 y 500 caracteres'),
  body('rol')
  ...
  body('ingresosMensuales')
    .optional()
    .isFloat({ min: 0 })
    .withMessage('Los ingresos mensuales deben ser un número mayor o igual a 0'),
  handleValidationErrors
];
...
const validateReservation = [
  ...
  body('nombreHuesped')
    ...
    .trim()
    .isLength({ max: 255 })
    .withMessage('El nombre del huésped no puede exceder 255 caracteres'),
  body('emailHuesped')
    .optional()
    .isEmail()
    .normalizeEmail()
    .withMessage('Email del huésped inválido'),
  handleValidationErrors
];
...
// Validaciones para tasaciones
const validateTasacion = [
  body('tituloPropiedad')
    .trim()
    .isLength({ min: 5, max: 255 })
    .withMessage('El título debe tener entre 5 y 255 caracteres'),
  body('direccionPropiedad')
    .trim()
    .isLength({ min: 5, max: 500 })
  ...
  body('habitaciones')
    .optional()
    .isInt({ min: 0, max: 20 })
    .withMessage('Las habitaciones deben ser un número entre 0 y 20'),
  body('banos')
    .optional()
    .isInt({ min: 0, max: 10 })
    .withMessage('Los baños deben ser un número entre 0 y 10'),
  body('superficieM2')
    .optional()
    .isFloat({ min: 0, max: 10000 })
    .withMessage('La superficie debe estar entre 0 y 10000 m²'),
...
const validateSearch = [
  ...
  query('habitacionesMin')
    .optional()
    .isInt({ min: 0 })
    .withMessage('Las habitaciones mínimas deben ser un número entero mayor o igual a 0'),
  query('banosMin')
    .optional()
    .isInt({ min: 0 })
    .withMessage('Los baños mínimos deben ser un número entero mayor o igual a 0'),
  handleValidationErrors
];
